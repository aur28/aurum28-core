...
{
    const char* pszTimestamp = "Aurum28 — launch 28/Aug/2025: 8-min blocks, 60 AUR reward, 28,000,000 cap";
    const char* premine_pubkey = "0369f816c8cf22028a0939eb891defbb8948d1777e352f6752254f0942208594ed";
    const CScript genesisOutputScript = CScript() << ParseHex(premine_pubkey) << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 229167;
        ...
        consensus.SegwitHeight = 12327; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        consensus.MinBIP9WarningHeight = 483840; // segwit activation height + miner confirmation window
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 8 * 60;      // 8 minutes
        ...
        genesis = CreateGenesisBlock(1756339200, 1, 0x207fffff, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x32d422ae4f68038a3005bb1c63894549cd9a460a9ed34fb28f6b4a93979b4acb"));
        assert(genesis.hashMerkleRoot == uint256S("0x3d9e04d2dce0d3164968c19ecda5fa09bd64cb0f8ef2afa55b2da6c441540fb3"));
        ...
        bech32_hrp = "aur";   // bech32 addresses like aur1...
...
public:
    CTestNetParams() {
     ...
     // assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>{23};   // legacy addresses start with 'A' range
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>{5};
        base58Prefixes[SECRET_KEY]     = std::vector<unsigned char>{151};
